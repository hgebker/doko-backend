...
import com.hgebk.doko.modelassembler.EarningModelAssembler;
import com.hgebk.doko.service.EarningService;
...
public class EarningController {
    ...
    public EarningController(
            EarningService earningService, EarningModelAssembler earningModelAssembler
    ) {
    ...
    public CollectionModel<EntityModel<Earning>> getAllEarnings() {
        List<EntityModel<Earning>> earnings = earningService
                .getAllEarnings()
                .stream()
