...
import com.hgebk.doko.modelassembler.SemesterModelAssembler;
import com.hgebk.doko.service.SemesterService;
...
public class SemesterController {
    ...
    public SemesterController(
            SemesterService semesterService, SemesterModelAssembler semesterModelAssembler
    ) {
    ...
    public CollectionModel<EntityModel<Semester>> getAllSemester() {
        List<EntityModel<Semester>> semester = semesterService
                .getAllSemesters()
                .stream()
